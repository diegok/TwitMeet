...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{TWITMEET_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{TWITMEET_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
twitmeet_server.pl - Catalyst Testserver

=head1 SYNOPSIS

twitmeet_server.pl [options]
